...
public class Main {
	...
	public static void main(String[] args) {
		...
		case 1:
			...
			resultat = new Calculatrice().additionner(nb1, nb2);
		...
		case 2:
			...
			System.out.println("Veuillez saisir le deuxième nombre : ");
			nb2 = scnb2.nextDouble();
			resultat = new Calculatrice().soustraire(nb1, nb2);
			System.out.println("Le résultat est : " + resultat);
			break;
		...
		case 3:
			...
			System.out.println("Veuillez saisir le deuxième nombre : ");
			nb2 = scnb2.nextDouble();
			resultat = new Calculatrice().multiplier(nb1, nb2);
			System.out.println("Le résultat est : " + resultat);
			break;
		...
		case 4:
			...
			System.out.println("Veuillez saisir le deuxième nombre : ");
			nb2 = scnb2.nextDouble();
			resultat = new Calculatrice().diviser(nb1, nb2);
			System.out.println("Le résultat est : " + resultat);
			break;
